...
const handleAdd = () => {
  router.push({ name: 'FactoryResignationAdd' })
}

const handleEdit = (row: Resignation) => {
  router.push({ name: 'FactoryResignationEdit', params: { id: row.id } })
}

const handleView = (row: Resignation) => {
  router.push({ name: 'FactoryResignationDetail', params: { id: row.id } })
}
