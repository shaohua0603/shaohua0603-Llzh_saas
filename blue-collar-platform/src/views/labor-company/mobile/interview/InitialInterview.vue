    ...
    interviews.value = [
      {
        ...
        factory: '富士康科技',
        position: '操作工',
        interviewTime: '2026-02-15 10:00',
        interviewAddress: '工厂面试室A',
        interviewer: '王主管',
        status: '待面试',
        type: '初步面试'
      },
      {
        ...
        factory: '华为技术',
        position: '质检员',
        interviewTime: '2026-02-15 14:00',
        interviewAddress: '工厂面试室B',
        interviewer: '李主管',
        status: '已通过',
        type: '初步面试'
      },
      {
        ...
        factory: '京东物流',
        position: '仓库管理员',
        interviewTime: '2026-02-16 09:00',
        interviewAddress: '工厂面试室A',
        interviewer: '张主管',
        status: '待面试',
        type: '初步面试'
...
const goToDetail = (item: any) => {
  router.push(`/tenant/interview/initial-interview-detail/${item.id}`)
}
        ...
        >
          ...
          <div class="item-info">
            ...
            <div class="info-row">
              ...
              <span class="value">{{ item.interviewTime }}</span>
            </div>
            <div class="info-row">
              <span class="label">面试地点：</span>
              <span class="value">{{ item.interviewAddress }}</span>
            </div>
            <div class="info-row">
              <span class="label">面试官：</span>
              <span class="value">{{ item.interviewer }}</span>
            </div>
          </div>
        </div>
      </div>
