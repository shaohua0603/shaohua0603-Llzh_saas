...
import { UserFilled, Timer, Money, OfficeBuilding, Key, Setting } from '@element-plus/icons-vue'
...
const todoList = ref([
  {
    id: 1,
    title: '工人入职审批',
    description: '张三的入职申请需要审批',
    time: '2026-02-25 10:00'
  },
  {
    id: 2,
    title: '薪资发放确认',
    description: '2月份薪资发放确认',
    time: '2026-02-25 09:00'
  },
  {
    id: 3,
    title: '考勤异常处理',
    description: '处理3名工人的考勤异常情况',
...
const warningList = ref([
  {
    id: 1,
    title: '考勤异常预警',
    description: '本周有5名工人考勤异常，需要及时处理',
    time: '2026-02-25 11:00'
  },
  {
    id: 2,
    title: '招聘需求预警',
    description: '生产部门招聘需求紧急，请加快招聘进度',
